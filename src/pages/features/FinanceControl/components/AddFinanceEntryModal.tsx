...
export default function AddFinanceEntryModal({ onClose, onSave }: AddFinanceEntryModalProps) {
  const [formState, setFormState] = useState({
    tipo: 'Entrada' as EntryType,
    descricao: '',
    centroCusto: 'Cultivo' as CostCenter,
      ...
      >
        <header className="modal-header">
          <div>
            ...
            <p className="modal-subtitle">Registre uma entrada ou saída financeira</p>
          </div>
